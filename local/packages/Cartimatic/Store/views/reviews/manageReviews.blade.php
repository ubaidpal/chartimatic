          ...
          <div class="order-wrapper">
              ...
              <div class="order-list-wrapper">
                <div class="col-md-7">
                  <div class="col-md-3">
                    ...
                    ?>
                    <div class="row"><a href="{{url('product/'.$orderProduct->product_id)}}"><img
                            src="{{getRandomImageOfProduct($orderProduct->product_id)}}" class="img-responsive" alt="a"
                            onError="this.onerror=null;this.src='<?php echo url('local/storage/app/')?>/product-images/default.jpg';"></a>
                    </div>
                  </div>
                  <div class="col-md-9">
                        ...
                        @if(isset($review->rating))
                          ...
                          @for($i=1; $i <= 5 - $review->rating; $i++)
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#review_{{$review->id}}">View Comment
                            </button>
            ...
            <div class="order-detail-wrapper">
              <div class="col-md-4">
                <div class="row">
                  <div class="left-col">
                    <div class="status">Order ID: {{$order->order_number}} <a
                          href="{{url('order-invoice/'.$order->id)}}">View Detail</a></div>
