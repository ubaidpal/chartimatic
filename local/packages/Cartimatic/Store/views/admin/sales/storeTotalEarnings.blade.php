        ...
        <div class="post-box">
            ...
            <div class="total-earning-wrapper">
                <div class="total-earning-box">
                    ...
                    <div class="earning-link"><a href="{{url('store/withdrawals')}}">Withdraw money &raquo;</a></div>
                </div>
                <div class="total-earning-box"> <?php $month_name = ''; if(isset($currentMonthSales['month_name'])){$month_name = $currentMonthSales['month_name'];} ?>
                    ...
                    <div class="earning-link"><a href="{{ url('store/'.$user->username.'/admin/statement') }}">View detail</a></div>
                </div>
