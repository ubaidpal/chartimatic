...
@section('content')
    ...
    <div class="col-md-12" style="background-color: #fff">
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="row">
                {!! Form::model(null , ['method' => 'POST', 'url' => "store/$store_id/admin/updateProductTemplate/$productTemplate->id","id" =>"updateProfileTemplate"]) !!}
                ...
                <div class="form-group row">
                    <div class="col-xs-10">
                        ...
                        {!!  Form::select('category_id', $categories, $productTemplate->category_id, ['class' => 'form-control category_id' ,'id' => 'categories'])!!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$productTemplate->name}}" type="text" name="name"
                               placeholder="Name">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$productTemplate->code}}" type="text" name="code"
                               placeholder="Code">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$productTemplate->sort_number}}" type="text"
                ...
                <div class="form-group pull-right">
                    ...
                    <a href="{{url('store/'.$store_id.'/admin/productTemplate')}}" class="btn btn-primary">Cancel</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        ...
        jQuery(document).ready(function(e){
            jQuery('#updateProfileTemplate').validate({
                errorElement : 'span',
                rules : {
        ...
        jQuery(document).on('click','.updateTemp',function(e){
            e.preventDefault();
            jQuery('#updateProfileTemplate').submit();
        });
