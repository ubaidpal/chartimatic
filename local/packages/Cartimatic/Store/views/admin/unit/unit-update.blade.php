...
@section('content')
    ...
    <div class="col-md-12" style="background-color: #fff">
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="row">
                {!! Form::model(null , ['method' => 'POST', 'url' => "store/$store_id/admin/updateUnit/$Unit->id","id" =>"updateUnit"]) !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$Unit->name}}" disabled="disabled" type="text" name="name"
                               placeholder="Name">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$Unit->code}}" disabled="disabled" type="text" name="code"
                               placeholder="Code">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$Unit->sort_number}}" type="text" name="sort_number"
                ...
                <div class="form-group pull-right">
                    <button type="submit" class="btn btn-success updateUnit">Update</button>
                    <a href="{{url('store/'.$store_id.'/admin/unit')}}" class="btn btn-primary">Cancel</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        ...
        jQuery(document).on('click','.updateUnit',function(e){
            e.preventDefault();
            jQuery('#updateUnit').submit();
        });
