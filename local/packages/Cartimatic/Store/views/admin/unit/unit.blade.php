...
@section('content')
    ...
    <div class="col-md-12" style="background-color: #fff">
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="row">
                {!! Form::model(null , ['method' => 'POST', 'url' => "store/$store_id/admin/savedUnit","id" =>"unit"]) !!}
                ...
                <div class="form-group pull-right">
                    <button type="submit" class="btn btn-success saveUnit">Save</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
                            ...
                            <tbody>
                                @foreach($Unit as $product)
                                    <tr>
                                        ...
                                        <td>
                                                <a href="{{url('store/'.$store_id.'/admin/editUnit/'.$product->id)}}" title="Edit">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>

                                                <a href="#" title="Delete" data-toggle="confirmation"
                                                   data-href="{{url('store/'.$store_id.'/admin/deleteUnit/'.$product->id)}}">
...
@section('scripts')
    ...
    <script>
        ...
        jQuery(document).on('click','.saveUnit',function(e){
            e.preventDefault();
            jQuery('#unit').submit();
        });
