...
<div class="mainCont">
    ...
    <div class="product-Analytics">
        <div class="post-box target" style="margin-top: 40px;">
            <h1>Orders</h1>
            ...
            <div class="bsmo-nav">
                ...
                <div class="bsmo-nav-itm">Affiliate Amount</div>
            ...
            @foreach($allOrders as $order)
                <div class="orderb-item orderBox order_item_{{$order->id}}">
                            ...
                            <div class="oi-image">
                                @foreach($orderAllProducts as $orderProduct)
                                    ...
                                    <div class="oi-product">
                                            ...
                                            <a class="product-img"
                                               href="{{url('product/'.$product->id)}}">
                                                ...
                                                <img class="product-image" width="100" height="100" src="{{$imageThumb}}"
                                                     alt="IMAGE" onError="this.onerror=null;this.src='{{getProductDefaultImage()}}';"></a>
                                        ...
                                        <div class="oi-product-item opi-txtb">${{$orderProduct->affiliate_reward_amount}}</div>
                            ...
                            <div class="oi-profile w230x">
                                @if(isset($product->owner_id))
                                    ...
                                    <p class="mb5">
                                        Buyer Name: <a
                                                target="_blank"
                                                href="{{profileAddress( $buyer )}}">
                                            <?php if(isset($buyer->id)){echo $buyerName = ucfirst($buyer->displayname);}else{echo 'Kinnect2 User'; } ?></a>
                                    </p>
                                @endif
                            </div>
                    ...
                    <div id="orderStatusWrap" class="orderStatusWrap">
                        ...
                        <div class="oi-status order_status_{{$order->id}}"><span>Order Status</span>{{$data['status']}}
                        </div>
                    </div>
                </div>
            @endforeach
