                ...
                @foreach($orderAllProducts as $orderProduct)
                    ...
                    <div class="orderb-item">
                        <div class="oi-header orderDetail">
                            ...
                            <div>&dollar;{{format_currency($discountValue)}}</div>
                            <div class="oi-quantity">
                                <p class="oi-price">{{$orderProduct->quantity}} Piece</p>
                            </div>
                            <div class="oi-amount">
                                <p class="oi-price">${{($product->price - $discountValue ) * $orderProduct->quantity}}</p>
                            </div>
                            <div class="oi-status"><?php echo $orderStatus['status'] ?></div>
                        </div>

                        <div class="ods-cd-item">
                            <?php $buyerName = getUserNameByUserId( $order->customer_id ); ?>
                            <div class="selected-item-detail">
                                <div class="ods-cdd-iteml">Buyer name :</div>
                                <div class="ods-cdd-itemr">{{ucfirst($buyerName)}}</div>
                            </div>
                            <div class="sid-link">
                                <a target="_blank" href="{{url('profile/'.$buyerName)}}">View Profile</a>
                            </div>
                        </div>
