    ...
    <div class="col-md-12" style="background-color: #fff">
        <div class="page-title">
            <div class="title_left">
                <h3>
                    {{Session::get('SYSTEM_CONFIGURATION.PRODUCT_VARIABLE_1')}}
                    <small>
                    </small>
                </h3>
            </div>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="row">
                {!! Form::model(null , ['method' => 'POST', 'url' => "store/$store_id/admin/savedAgeGroup","id" =>"savedItem"]) !!}
                            ...
                            <tbody id="product-wrapper">
                                @foreach($ageGroup as $product)
                                    <tr>
                                       ...
                                       <td>
                                                <a href="{{url('store/'.$store_id.'/admin/editAgeGroup/'.$product->id)}}" title="Edit">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>

                                                <a href="#" title="Delete" data-toggle="confirmation"
                                                   data-href="{{url('store/'.$store_id.'/admin/deleteAgeGroup/'.$product->id)}}">
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on("click", "#categories", function (e) {
            ...
            jQuery.ajax({
                url: '{{ url("store/$store_id/admin/ageGroupFilter") }}',
                type: "Post",
