...
@section('content')
    ...
    <div class="col-md-12" style="background-color: #fff">
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="row">
                {!! Form::model(null , ['method' => 'POST', 'url' => "store/$store_id/admin/updateLineItem/$lineItems->id","id" =>"updateProfileTemplate"]) !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$lineItems->name}}" disabled="disabled" type="text"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$lineItems->code}}" disabled="disabled" type="text"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$lineItems->sort_number}}" type="text" name="sort_number"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <textarea class="form-control" name="comments"
                                  placeholder="Type your comments">{{$lineItems->comments}}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="comments" class="col-xs-2 col-form-label"></label>
                    <div class="col-xs-10">
                    <label class="checkbox-inline"><input type="checkbox"  name="size_color" @if(@$lineItems->size_color == '1') checked="checked" @endif value="" />&nbsp;With Size and Color</label>
                    <label class="checkbox-inline"><input type="checkbox" name="one_load_item" @if(@$lineItems->one_load_item == '1') checked="checked" @endif value="" />&nbsp; OneLoad Line item</label>
                    </div>
                </div>
