    ...
    <div class="col-md-12" style="background-color: #fff">
        <div class="page-title">
            <div class="title_left">
                <h3>
                    Update {{Session::get('SYSTEM_CONFIGURATION.PRODUCT_VARIABLE_3')}}
                    <small>
                    </small>
                </h3>
            </div>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="row">
                {!! Form::model(null , ['method' => 'POST', 'url' => "store/$store_id/admin/updateLifeType/$lifeType->id","id" =>"updateLifeType"]) !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$lifeType->name}}" disabled="disabled" type="text"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$lifeType->code}}" disabled="disabled" type="text"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$lifeType->sort_number}}" type="text" name="sort_number"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <textarea class="form-control" name="comments"
                                  placeholder="Type your comments">{{$lifeType->comments}}</textarea>
                    </div>
                </div>

                <div class="form-group pull-right">
                    <button type="submit" class="btn btn-success updateLifeType">Update</button>
                    <a href="{{url('store/'.$store_id.'/admin/lifeType')}}" class="btn btn-primary">Cancel</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        ...
        jQuery(document).ready(function(e){
            jQuery('#updateLifeType').validate({
                errorElement : 'span',
                rules : {
        ...
        jQuery(document).on('click','.updateLifeType',function(e){
            e.preventDefault();
            jQuery('#updateLifeType').submit();
        });
