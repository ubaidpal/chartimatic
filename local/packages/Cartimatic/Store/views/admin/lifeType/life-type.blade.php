    ...
    <div class="col-md-12" style="background-color: #fff">
        <div class="page-title">
            <div class="title_left">
                <h3>
                    {{Session::get('SYSTEM_CONFIGURATION.PRODUCT_VARIABLE_3')}}
                    <small>
                    </small>
                </h3>
            </div>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="row">
                {!! Form::model(null , ['method' => 'POST', 'url' => "store/$store_id/admin/savedLifeType","id" =>"lifeType"]) !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                    <input class="form-control" value="{{@$name}}" type="text" name="name" placeholder="Name e.g Box">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                    <textarea class="form-control"  name="comments" placeholder="Type your comments">{{@$Unit->comments}}</textarea>
                    </div>
                </div>

                <div class="form-group pull-right">
                    <button type="submit" class="btn btn-success saveLifeType">Save</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
                ...
                <div class="x_panel">
                    <div class="x_content table-responsive">
                        <table id="datatable-buttons" class="table table-striped table-bordered table-hover">
                            <thead>
                            <tr>
                                <th>Life Type Name</th>
                                <th>Life Type Code</th>
                                <th>Sort Order</th>
                                <th>Comments</th>
                                <th>Action</th>
                            ...
                            <tbody>
                                @foreach($lifeType as $product)
                                    <tr>
                                        ...
                                        <td>
                                                <a href="{{url('store/'.$store_id.'/admin/editLifeType/'.$product->id)}}" title="Edit">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>

                                                <a href="#" title="Delete" data-toggle="confirmation"
                                                   data-href="{{url('store/'.$store_id.'/admin/deleteLifeType/'.$product->id)}}">
...
@section('scripts')
    ...
    <script>
        ...
        jQuery(document).on('click','.saveLifeType',function(e){
            e.preventDefault();
            jQuery('#lifeType').submit();
        });
