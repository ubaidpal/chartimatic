...
@section('content')
    ...
    <div class="col-md-12" style="background-color: #fff">
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="row">
                {!! Form::model(null , ['method' => 'POST', 'url' => "store/$store_id/admin/updateCalenderSeason/$calenderSeason->id","id" =>"updateCalenderSeason"]) !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                    <input class="form-control" value="{{$calenderSeason->name}}" disabled="disabled" type="text" name="name" placeholder="Name">
                   </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$calenderSeason->code}}" disabled="disabled" type="text"
                ...
                <div class="form-group row">
                    ...
                    if(\Request::old('opening_date')){
                        $opening_date = \Request::old('start_season');
                    }
                    ?>
                ...
                <div class="form-group row">
                    ...
                    if(\Request::old('end_date')){
                        $end_date = \Request::old('end_season');
                    }
                    ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$calenderSeason->sort_number}}" type="text"
                               name="sort_number" placeholder="Sort Order">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <textarea class="form-control" name="comments"
                                  placeholder="Type your comments">{{$calenderSeason->comments}}</textarea>
                    </div>
                </div>
                <div class="form-group pull-right">
                    <button type="submit" class="btn btn-success updateCalender">Update</button>
                    <a href="{{url('store/'.$store_id.'/admin/calenderSeason')}}" class="btn btn-primary">Cancel</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        ...
        jQuery(document).ready(function(e){
            jQuery('#updateCalenderSeason').validate({
                errorElement : 'span',
                rules : {
        ...
        jQuery(document).on('click','.updateCalender',function(e){
            e.preventDefault();
            jQuery('#updateCalenderSeason').submit();
        });
