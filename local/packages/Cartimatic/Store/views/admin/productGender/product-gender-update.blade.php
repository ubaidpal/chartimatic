    ...
    <div class="col-md-12" style="background-color: #fff">
        <div class="page-title">
            <div class="title_left">
                <h3>
                    Update {{Session::get('SYSTEM_CONFIGURATION.PRODUCT_VARIABLE_4')}}
                    <small>
                    </small>
                </h3>
            </div>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="row">
                {!! Form::model(null , ['method' => 'POST', 'url' => "store/$store_id/admin/updateProductGender/$productGender->id","id" =>"updateProductGender"]) !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" value="{{$productGender->name}}" disabled="disabled" type="text"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                    <input class="form-control" value="{{$productGender->code}}" disabled="disabled" type="text" name="code" placeholder="Code">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                    <input class="form-control" value="{{$productGender->sort_number}}" type="text" name="sort_number" placeholder="Sort Order">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <textarea class="form-control" name="comments"
                                  placeholder="Type your comments">{{$productGender->comments}}</textarea>
                    </div>
                </div>

                <div class="form-group pull-right">
                    <button type="submit" class="btn btn-success updateProductGender">Update</button>
                    <a href="{{url('store/'.$store_id.'/admin/productGender')}}" class="btn btn-primary">Cancel</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        ...
        jQuery(document).ready(function(e){
            jQuery('#updateProductGender').validate({
                errorElement : 'span',
                rules : {
        ...
        jQuery(document).on('click','.updateProductGender',function(e){
            e.preventDefault();
            jQuery('#updateProductGender').submit();
        });
