    ...
    <div class="col-md-12" style="background-color: #fff">
        <div class="page-title">
            <div class="title_left">
                <h3>
                    {{Session::get('SYSTEM_CONFIGURATION.PRODUCT_VARIABLE_4')}}
                    <small>
                    </small>
                </h3>
            </div>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="row">
                {!! Form::model(null , ['method' => 'POST', 'url' => "store/$store_id/admin/savedProductGender","id" =>"productGender"]) !!}
                ...
                <div class="form-group pull-right">
                    <button type="submit" class="btn btn-success saveProductGender">Save</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
                ...
                <div class="x_panel">
                    <div class="x_content table-responsive">
                        <table id="datatable-buttons" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                @foreach($productGender as $product)
                                    <tr>
                                        ...
                                        <td>
                                                <a href="{{url('store/'.$store_id.'/admin/editProductGender/'.$product->id)}}" title="Edit">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>

                                                <a href="#" title="Delete" data-toggle="confirmation"
                                                   data-href="{{url('store/'.$store_id.'/admin/deleteProductGender/'.$product->id)}}">
...
@section('scripts')
    ...
    <script>
        ...
        jQuery(document).on('click','.saveProductGender',function(e){
            e.preventDefault();
            jQuery('#productGender').submit();
        });
