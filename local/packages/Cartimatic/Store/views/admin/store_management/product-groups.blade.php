    ...
    <div>
        <div class="page-title">
            ...
            <div class="pull-right">
                <a class="btn btn-primary btn-sm" href="{{url('store/'.$store_id.'/admin/addProductGroup')}}"><i class="glyphicon glyphicon-plus"></i>&nbsp;Add</a>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{url('store/'.$store_id.'/admin/addProductGroup/'.$supplier->id)}}"><i class="fa fa-pencil-square-o"></i></a>&nbsp;|&nbsp;
                                        <a href="{{url('store/'.$store_id.'/admin/deleteProductGroup/'.$supplier->id)}}" class="text-danger delete-supplier"><i class="fa fa-times-circle-o"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                @else
