    ...
    <div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal" method="post" action="{{url('store/'.$store_id.'/admin/postBrand')}}" id="addBrandForm">
                            <input type="hidden" name="supplier-id" value="{{@$supplier->id}}">
                            <div class="form-group">
                                <label class="control-label col-md-3">Name:</label>
                                <div class="col-md-4">
                                    <input type="text" name="name" class="form-control" value="@if(!empty(\Request::old('name'))){{\Request::old('name')}} @else{{@$supplier->name}}@endif">
                                    <label id="name-error" class="error text-danger" for="name">{{@$errors->first('name')}}</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Brand Code:</label>
                                <div class="col-md-4">
                                    <input type="text" name="code" class="form-control" value="@if(!empty(\Request::old('code'))){{\Request::old('code')}} @else {{@$supplier->code}} @endif">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="contact_no" class="form-control" value="@if(!empty(\Request::old('contact_no'))){{\Request::old('contact_no')}}@else{{@$supplier->contact_no}}@endif">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 ">
                                    ...
                                    <a href="{{url('store/'.$store_id.'/admin/brands')}}" class="btn btn-default btn-sm pull-right">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
