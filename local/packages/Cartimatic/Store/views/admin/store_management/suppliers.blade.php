    ...
    <div>
        @if(Session::has('message'))
            <div class="alert alert-danger fade in">
                <a href="#" class="close"
                   data-dismiss="alert {{ Session::get('alert-class display-danger', 'alert-info') }}"
        ...
        <div class="page-title">
            ...
            <div class="pull-right">
                <a class="btn btn-primary btn-sm" href="{{url('store/'.$store_id.'/admin/addSupplier')}}"><i class="glyphicon glyphicon-plus"></i>&nbsp;Add</a>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{url('store/'.$store_id.'/admin/addSupplier/'.$supplier->id)}}"><i class="fa fa-pencil-square-o"></i></a>&nbsp;|&nbsp;
                                        <a href="{{url('store/'.$store_id.'/admin/deleteSupplier/'.$supplier->id)}}" class="text-danger delete-supplier"><i class="fa fa-times-circle-o"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                @else
