...
@section('content')
    ...
    <div class="col-md-12" style="background-color: #fff">
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="row">
                {!! Form::model(null , ['method' => 'POST', 'url' => "store/$store_id/admin/updateProductGroups/$storeGroup->id","id" =>"storeGroup"]) !!}
                ...
                <div class="form-group row">
                    <?php $categories = allCategory();?>
                        ...
                        <div class="col-xs-10">
                        {!!  Form::select('category_id', $categories, $storeGroup->category_id, ['class' => 'form-control category_id' ,'id' => 'categories'])!!}
                        </div>
                </div>
                <div class="form-group row">
                    <label for="name" class="col-xs-2 col-form-label">Name</label>
                    <div class="col-xs-10">
                    <input class="form-control" value="{{$storeGroup->name}}" disabled="disabled" type="text" name="name" placeholder="Name">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                    <input class="form-control" value="{{$storeGroup->code}}" disabled="disabled" type="text" name="code" placeholder="Code">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                    <input class="form-control" value="{{$storeGroup->sort_number}}" type="text" name="sort_number" placeholder="Sort Order">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                    <textarea class="form-control"  name="comments" placeholder="Type your comments">{{$storeGroup->comments}}</textarea>
                   </div>
                </div>

                <div class="form-group pull-right">
                    <button type="submit" class="btn btn-success updateGroup">Update</button>
                    <a href="{{url('store/'.$store_id.'/admin/lineItem')}}" class="btn btn-primary">Cancel</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        ...
        jQuery(document).on('click','.updateGroup',function(e){
            e.preventDefault();
