                            ...
                            <div id="presetShippingAddress_{{$previousAddress->id}}" class="col-md-4">
                                ...
                                <div class="shiping-address">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{url("store/add/shipping/address/".$sellerBrandIdEncoded.'/'.$buy_it_now)}}" id="address_box_{{$previousAddress->id}}" data-country="{{$previousAddress->country_id}}" class="btn btn-default ship_to_btn">Ship to this address</a>
                ...
                <div class="col-md-7">
                    ...
                    <input type="hidden" id="address_id" name="address_id">
                        ...
                        <div class="form-box">
                            ...
                            <button class="btn btn-default new_shipping_address_btn" type="submit">Ship to this address</button>
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
...
@section('footer-scripts')
    ...
    <script type="text/javascript">
        ...
        $(".ship_to_btn").click(function(evt){
            ...
            var goUrl = urlToGo+"/"+address_id+"/"+buy_it_now;
