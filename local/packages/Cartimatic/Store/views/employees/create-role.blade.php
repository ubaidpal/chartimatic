...
@include('includes.alerts')
                        {!! Form::open(['url' => 'admin/store/employees/storeRole','class' => 'form-horizontal form-label-left','data-parsley-validate', 'enctype'=>"multipart/form-data" , 'id' => 'storeRole']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="name" id="role_name" required="required"
