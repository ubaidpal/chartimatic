...
@section('content')
    ...
    <div class="">
        <div class="page-title">
            ...
            <a href="{{url('admin/store/employees/create-role')}}" class="btn btn-success pull-right" type="button">Add New</a>
        </div>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($roles as $role)
                                <tr>
                                    ...
                                    <td>{{$role->name}}</td>
                                    <td>
                                        <a href="{{url('admin/store/employees/edit-role/'.$role->id)}}" title="Edit">
                                            <i class="fa fa-edit fa-2x"></i>
                                        </a>
                                        <a href="#" title="Delete" data-toggle="confirmation" data-href="{{url('admin/store/employees/delete-role/'.$role->id)}}">
