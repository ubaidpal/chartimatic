            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        {!! Form::model($employee,['url' => 'admin/store/employees/update/'.$employee->id,'class' => 'form-horizontal form-label-left','data-parsley-validate', 'enctype'=>"multipart/form-data",'method' => 'patch' , 'id' => 'empForm']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('phone_number',NULL, ['class' =>'form-control col-md-7 col-xs-12','required' ] ) !!}
                        ...
                        <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Birthday <span
                                        class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::date('birthday',NULL, ['class' =>'form-control col-md-7 col-xs-12','required','id'=>'birthday' ] ) !!}
                        ...
                        <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Hire Date <span
                                        class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::date('hire_date',NULL, ['class' =>'form-control col-md-7 col-xs-12','required','id'=>'hire_date' ] ) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                ?>
                                {!! Form::select('employee_type', $roles, null, ['class' => 'form-control col-md-7 col-xs-12', 'required','placeholder' => 'Select Employee Role']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Employee Picture</label>
                        ...
                        <div class="form-group" id="preview">
                            <div class="right col-xs-3 col-md-1 text-center col-md-offset-3 col-sm-offset-3">
                                <img class="img-circle img-responsive" src="{{url($employee->employee_picture)}}" alt="">
                            </div>
                        </div>
