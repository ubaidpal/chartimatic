...
use Cartimatic\Store\Repository\StoreOrderRepository;
...
class DisputeController extends Controller
{
    ...
    public function saveDispute(Request $request) {
        ...
        if($order_id > 0) {
            return redirect('store/dispute/detail/' . $order_id);
            // return $order_id;
        }
    ...
    public function get_dispute($id, $type = NULL) {
        ...
        if(!is_null($type)){
            return view('Store::admin.dispute.dispute-detail', $this->data);
        }
    ...
    public function delete_attachment() {
        ...
        RefundRequestAttachment::destroy($id);
        return 1;
    }
}
