...
class StoreManagementController extends Controller
{
    ...
    public function addBankAccount(Request $request)
    {
        ...
        return redirect('store/' . Auth::user()->username . '/admin/withdrawal');
    }
    ...
    public function requestWithdrawal()
    {
        ...
        $data['url_user_id'] = $this->user_id;
        return view('Store::store_management.withdrawal', $data);
    }
    ...
    public function cancelWithdrawalRequest(Request $request)
    {
        ...
        $withdrawal = StoreWithdrawal::where('id', $request->withdrawal_id)->where('seller_id', $this->user_id)->first();
