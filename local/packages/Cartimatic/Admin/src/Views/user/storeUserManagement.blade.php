 	...
 	<div class="ad_main_wrapper" id="ad_main_wrapper">
       <div class="task_inner_wrapper">
           ...
           <div class="task-tabs">
               ...
               <a class="orngBtn fltR" href="{{url('admin/users/create')}}" style="padding: 0 10px;">Add User</a>
            ...
            @foreach($users as $user)
                <div class="user-table">
                    ...
                    <div class="action">
                        ...
                        <?php } ?>
                        <?php } ?>
                        <a href="{{url('admin/users/edit/'.$user->id)}}" class="editUser" id="{{$user->id}}">Edit</a>
                        <a href="#" class="deleteUser" id="{{$user->id}}">Delete</a></div>
...
<div class="modal-box cart" id="confirmation_popup" style="display: none;">
    ...
    <div class="modal-body">
        <div class="edit-photo-poup">
            <p class="mt10" style="width: 400px;height: 30px;line-height: normal">Are you sure you want delete this user?</p><br>
