...
<div class="ad_main_wrapper">
    <div class="task_inner_wrapper">
        ...
        <div class="task-tabs">
            <a href="{{url('admin/withdrawalRequests')}}">Withdrawal</a>
            <a class="active" href="#">Affiliates Withdrawal</a>
        ...
        <div class="awd-6con">
            ...
            @foreach($withdrawals as $withdrawal)
                @if(!isset($withdrawal->seller->displayname))
                    <?php continue; ?>
                @endif
            <div class="awd-item">
                <div class="awdi-itm"><span class="brand">{{$withdrawal->seller->displayname}}</span><span class="awdi-badge">(Affiliated Member)</span></div>
