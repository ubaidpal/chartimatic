    ...
    <div class="product-Analytics">
        <div class="post-box">
            ...
            <div class="selectdiv m0">
                <div class="mb10">
                    {!! Form::open(['url' => url("admin/save/Subcategories"), "id" => "SubCategory", "enctype"=>"multipart/form-data"]) !!}
            ...
            @if(is_object($allSubCategories))
                <div id="wrap_categories_list">
                    @foreach($allSubCategories as $Subcategory)
                        ...
                        {!! Form::open(array('class' => 'edit','method'=> 'post','url'=> "admin/edit/Subcategory/".$Subcategory->id)) !!}
                        ...
                        {!! Form::close() !!}
                        {!! Form::open(array('method'=> 'get','url'=> "admin/delete/Subcategories/".$Subcategory->id)) !!}
...
<script>
    function getFilteredSubcategory(evt){
        ...
        jQuery.ajax({
            url: '{{ url("admin/filteredCategory") }}',
            type: "Post",
    ...
    $("#name").keypress(function (evt) {
        ...
        jQuery.ajax({
            url: '{{ url("admin/checkIfAlreadySubCatAjax") }}',
            type: "Post",
