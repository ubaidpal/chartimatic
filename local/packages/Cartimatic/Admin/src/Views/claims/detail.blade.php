...
<div class="ad_main_wrapper">
    <div class="task_inner_wrapper">
        <div class="main_heading">
            ...
            @if($claim->status != \Config::get('admin_constants.CLAIM_STATUS.RESOLVED') && Auth::user()->id === $claim->arbitrator_id)
        ...
        <div class="assigned-task-wrapper">
                    ...
                    <div class="dispute-row">
                        ...
                        <div class="detail">
                            ...
                            @foreach($files as $row)
                                ...
                                ?>
                                <img src="{!! getImage($row->attachment_path, 'refund_request') !!}" width="75"
                                     height="75"
                                     alt="dispute images"/>
                            @endforeach
            ...
            @if($claim->status != \Config::get('admin_constants.CLAIM_STATUS.RESOLVED') && Auth::user()->id === $claim->arbitrator_id)
                <div class="dispute-msg-write">
                    ...
                    <button type="submit" class="orngBtn cht-send" id="send-msg">Send</button>
...
@section('footer-scripts')
    ...
    {!! HTML::script('local/public/assets/admin/dispute.js') !!}
    <style>
    ...
    <div id="claim-resolved" class="cssPopup_overlay">
        <div class="cssPopup_popup">
            ...
            <div class="bank-detail-popup">
                ...
                <div class="bd-itm " id="buyer-amount" style="display: none">
