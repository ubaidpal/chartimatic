...
class UsersController extends Controller
{
    ...
    public function index() {
        ...
        return view("Admin::user.dashboard", $data)->with('title', 'Admin: Dashboard');
    }
    ...
    public function store(Request $request) {
        ...
        if($user === NULL) {
            ...
            return redirect('admin/users')->with('info', 'Email send to user..');
        } else {
    ...
    public function normal_users() {
        ...
        })->orderBy('id', 'DESC')->orderBy('id', 'DESC')->paginate(25);
    ...
    public function destroy() {
        ...
        StoreProduct::where('owner_id', $user_id)->delete();
        return 1;
    }
