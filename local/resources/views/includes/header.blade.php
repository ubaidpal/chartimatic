            ...
            <div class="col-md-9">
            	<div class="row">
                    ...
                    <ul class="nav navbar-nav">
                      <li @if(isset($active_top_link_number)) @if($active_top_link_number == 1) class="active" @endif @endif><a href="{{url('new-arrivals')}}"><span class="txt">New Arrivals</span></a></li>
                      <li @if(isset($active_top_link_number)) @if($active_top_link_number == 2) class="active" @endif @endif><a href="{{url('top-sellers')}}"><span class="txt">top sellers</span></a></li>
                      <li @if(isset($active_top_link_number)) @if($active_top_link_number == 2) class="active" @endif @endif><a href="{{url('top-sellers')}}"><span class="txt">deals</span></a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                      <li class="dropdown" title="Country: Pakistan">
                      ...
                      <li class="dropdown " title="Currency: Pakistan Rupees">
                        <!--<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">-->
                       <a href="javascript:void(0);">PKR</a>
                        <!--<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                          <li><a href="#">AED</a></li>
                          <li><a href="#">Rs</a></li>
                    ...
                    <div class="col-md-7">
                    	...
                    	<div class="search-area">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-btn search-panel">
                                    ...
                                    <?php $categories = allCategory();?>
                                        @if(isset($parent_category_id))
                                            {!!  Form::select('category_id', $categories, $parent_category_id, ['class' => 'btn btn-default dropdown-toggle' ,'id' => 'categories'])!!}@else
                                ...
                                <span>
                                <input type="text" autocomplete="off" class="form-control filter_product" name="search" id="filter_product"  placeholder="I want___">
                        ...
                        <div class="row">
                            <div class="cart-wrapper">
                                ...
                                <?php $totalProducts = countCartProducts() ?>
                                 <a href="{{url('store/cart')}}" class="items-total">{{$totalProducts}}</a>
                              </div>
                            @if(Auth::check())
                                <div class="dropdown userdropdown">
                                    <button class="btn btn-primary dropdown-toggle" id="menu1" type="button" data-toggle="dropdown">Hi, {{str_limit(trim(Auth::user()->displayname), 10, '..')}}
...
.'/admin/orders')}}">Store Dashboard</a></li>
                            ...
                            @if(!Auth::check())
                                <a href="#" title="Login" data-toggle="modal" data-target="#myModalSignin">Login</a>
...
Avoid using the same password for multiple sites." aria-describedby="tooltip">?</button>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="password" title="Please enter your password" required="" value="" name="password_confirmation" onblur="focusNextButton();" id="password_confirmation" class="form-control">
                                                                    <span class="help-block" id="confirm-password-help"></span>
                                                                </div>
                                                                <div class="form-group hide store-name-container">
                                                                    <label class="control-label" for="password">Store Name</label>
                                                                    <input type="text" title="Store name" placeholder="Store name" name="store_name" id="store_name"  class="form-control">
...
@section('footer-scripts-header-search')
    ...
    function validDataStep1(errorCheckType){
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(response == ''){
                    $('.actionBar').find('.btn-success').fadeIn();
                }
            }
        });
    }
