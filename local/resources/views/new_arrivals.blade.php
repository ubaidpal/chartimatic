        ...
        <div class="col-md-9">
            <div class="row">
                <div class="order-title-box">
                    <div class="select-category">
                        <div class="input-group">
                            <label style="margin-bottom: 5px;" for="new_arrivals_categories">Filter By Category</label>
                            {!!  \Form::select('new_arrivals_categories', $newArrivalsProductsCategories, 0, ['class' => 'form-control' ,'id' => 'new_arrivals_categories'])!!}
                ...
                <div class="order-wrapper">
                    @foreach($newArrivalsProducts as $favoriteProduct)
                                ...
                                <a title="Click to view detail." href="{{url('product/'.$favoriteProduct->id)}}" id="{{$favoriteProduct->id}}">
                                    <div class="col-md-3 col-xs-4">
                                        <div class="row">
                                            ...
                                            @else
                                                <img alt="{{$favoriteProduct->title}}" class="img-responsive"
                                                     onError="this.onerror=null;this.src='<?php echo url('local/storage/app/')?>/product-images/default.jpg';" src="{!! getImage(null) !!}">
                                            @endif
...
<script>
    ...
    $("#new_arrivals_categories").change(function(){
       var products = $(".order-list-wrapper");
       products.hide();
       $("#show_all").show();

       products.each(function(){
           if($(this).data('filter') == $("#new_arrivals_categories").val()){
