                            ...
                            <div id="presetShippingAddress_{{$previousAddress->id}}" class="col-md-4">
                                ...
                                <div class="shiping-address">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{url("store/add/shipping/address/".$sellerBrandIdEncoded)}}" id="address_box_{{$previousAddress->id}}" data-country="{{$previousAddress->country_id}}" class="btn btn-default ship_to_btn">Ship to this address</a>
