					...
					<form class="navbar-form p0 m0 pull-right" role="search">
						<div class="input-group add-on">
							...
							<div class="input-group-btn">
								<button class="btn search-category-products-btn" type="submit">Search</button>
							</div>
						</div>
					</form>
				</div>
					...
					<div class="row">
						<div class="product-information">
							...
							<div class="p-common-box clearfix">
								...
								<div class="span3">
									<div class="row">
										<div class="input-group select-qty mt0 mb10">
											<input type="number" name="quant[1]" class="form-control input-number" value="1" min="1" max="10" style="
						text-align: center;
					">
										</div>
									</div>
							...
							<div class="social-share shipping-wrap">
								...
								<div class="span3">
									<div class="row share_on_social_media"></div>
								</div>
							</div>
						</div>
					</div>
