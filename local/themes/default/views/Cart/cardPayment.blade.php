                        ...
                        <div class="col-md-8">
                            <div class="shipping-form">
                                ...
                                <div class="form-box">
                                    ...
                                    <input data-worldpay="exp-month" placeholder="MM" size="6" type="text" style="text-align:center;" />

                                    <input data-worldpay="exp-year" placeholder="YYYY" size="10" type="text"  style="text-align:center;"/>
                                ...
                                <button class="btn btn-primary mb15 payNowBtn" type="submit" style="margin-top:0;">Pay now</button>
                                </form>
                            </div>
                        </div>
                    </div>
