                    ...
                    @if(is_object($subCategories))
                        @foreach($subCategories as $subCategoryItem)
                            ...
                            if(isLeafCategory($subCategoryItem->id) == 0){
                                $childProductsCount = hasProducts($subCategoryItem->id,$store_id);
                                if($childProductsCount == 0){continue;}
                            }else{
                                $parentProductCount = parentHasProducts($subCategoryItem->id,$store_id);
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="row">
                                ...
                                @foreach($allSubCategories as $subCategory)
                                    ...
                                    {
                                        if(hasProducts($subCategory->id,$store_id) == 0)
                                        {
                                            continue;
                                        }
                                    }else{
                                        if(parentHasProducts($subCategory->id,$store_id) == 0)
                                        {
                                            continue;
                                        }
                                    }
                                    ...
                                    $childProductsCount = null;
                                    $childProductsCount = hasProducts($subCategory->id,$store_id);
