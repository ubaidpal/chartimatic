...
return [
    ...
    'DISPUTE_NOTE'  => [
        ...
        'BRAND' => 'If you cannot respond to this refund request then buyer can open a dispute. When dispute is open the CARTIMATIC Arbitrator can solve the dispute.',

        'DISPUTE_ACCEPTED_SELLER' => 'The refund request has been accepted and the amount has been transferred.',
        'DISPUTE_ACCEPTED_BUYER'  => 'The refund request has been accepted and the amount has been transferred.',
    ],
    'RETURNS'       => [
        'NORMAL'   => 1,
        'SEASONAL' => 2,
