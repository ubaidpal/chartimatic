...
class FriendshipRepository extends Repository implements RepositoryInterface
{
     ...
     */
    public function __construct( UsersRepository $usersRepository, NotificationRepository $notificationRepository) {
        parent::__construct();
    ...
    public function get_all_info($user_id, $skip_id = NULL) {
