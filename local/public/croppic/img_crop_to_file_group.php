...
if($cropped_cover_file_id != "" && $_GET['group_id'] != ''){
	$sqlUpdateCoverPhoto = "UPDATE engine4_group_groups SET cover_photo_id = ".$cropped_cover_file_id." WHERE group_id= ".$_GET['group_id']." ";
