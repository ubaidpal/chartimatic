...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        ...
        finish  : $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("btn btn-default finish-btn-hide")
    };
...
// Default Properties and Events
    ...
    function validateSteps(stepnumber){
        ...
        if(stepnumber == 1){
            ...
            if($(document).find("#email-help").html() != '' || $(document).find("#username").val() == ""){
                validDataStep1("email");
                $("#email-help").html();
                isStepValid = false;
            }

            if($(document).find("#password-help").html() != '' || $(document).find("#password").val() == ""){
                validDataStep1("password");
                isStepValid = false;
            }

            if($(document).find("#confirm-password-help").html() != '' || $(document).find("#password_confirmation").val() == ""){
                validDataStep1("password");
                isStepValid = false;
            }
        }
        ...
        if(stepnumber == 2){
            if($(document).find("#first_name-help").html() != '' || $(document).find("#first_name").val() == ""){
                validDataStep2();
                isStepValid = false;
            }

            if($(document).find("#last_name-help").html() != '' || $(document).find("#last_name").val() == ""){
                validDataStep2();
                isStepValid = false;
            }

            if(isStepValid == true){
                $(".actionBar > .btn-default").removeClass("finish-btn-hide");
                $(".actionBar > .btn-success").addClass("finish-btn-hide");
            }
        }
        return isStepValid;
    }
