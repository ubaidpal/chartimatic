...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        next : $('<a>'+options.labelNext+'</a>').attr("href","#").addClass("btn btn-success next_btn"),
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("btn btn-primary previous_btn"),
        finish  : $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("btn btn-default finish_btn")
    };
